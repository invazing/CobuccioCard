...
Public Class Form_PsqTransacoes
    ...
    Private Sub btnEditar_Click(sender As Object, e As EventArgs) Handles btnEditar.Click
        ...
        Catch ex As Exception
            ModLogHelper.RegistrarErro("EditarTransacao", ex)
    ...
    Private Sub btnDeletar_Click(sender As Object, e As EventArgs) Handles btnDeletar.Click
        Try
            ...
            End If
        Catch ex As Exception
            ModLogHelper.RegistrarErro("ExcluirTransacao", ex)
    ...
    Private Sub btnExport_Click(sender As Object, e As EventArgs) Handles btnExport.Click
        ...
        If gridTransacoes.DataSource Is Nothing OrElse CType(gridTransacoes.DataSource, DataTable).Rows.Count = 0 Then
